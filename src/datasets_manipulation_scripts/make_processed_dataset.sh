...
split -C 11m --numeric-suffixes data/interim/wiki_pt_splits/wiki_pt00.txt data/processed/splits/main_
# split -C 1200k --numeric-suffixes data/processed/splits/main_01 data/processed/splits/test_val_

cp data/processed/train.txt data/processed/train_3M_tokens.txt
