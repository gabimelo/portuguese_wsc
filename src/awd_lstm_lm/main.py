...
from src.awd_lstm_lm.utils import batchify, get_batch, repackage_hidden
...
if os.path.exists(fn):
    ...
    import pickle
    corpus = pickle.load(open(fn, "rb"))
    print(f'Corpus dictionary len: {len(corpus.dictionary)}')
else:
...
from src.awd_lstm_lm.splitcross import SplitCrossEntropyLoss
criterion = None
